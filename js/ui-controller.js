...
function bindUIEvents() {
  ...
  document
    .getElementById("grid-cols-select")
    .addEventListener("change", (e) => {
  ...
  document
    .getElementById("hide-student-info")
    .addEventListener("change", (e) => {
  ...
  document.getElementById("pattern-guide").addEventListener("change", (e) => {
    AppState.patternGuide = e.target.checked;
    markStateChanged();
    renderPages();
  });
  document.getElementById("pattern-empty").addEventListener("change", (e) => {
    AppState.patternEmpty = e.target.checked;
    markStateChanged();
    renderPages();
  });
  document
    .getElementById("exclude-first-page")
    .addEventListener("change", (e) => {
  ...
  document
    .getElementById("hide-manuscript-header")
    .addEventListener("change", (e) => {
      AppState.hideManuscriptHeader = e.target.checked;
      markStateChanged();
      renderPages();
    });
  document.getElementById("hide-char-count").addEventListener("change", (e) => {
    AppState.hideCharCount = e.target.checked;
    markStateChanged();
    renderPages();
  });
  document
    .getElementById("hide-page-numbers")
    .addEventListener("change", (e) => {
      AppState.hidePageNumbers = e.target.checked;
      markStateChanged();
      renderPages();
    });
  document
...
function bindDocumentEvents() {
  ...
  document.addEventListener("input", (e) => {
    ...
    if (target.classList.contains("school-placeholder")) {
      ...
      document.getElementById("input-school").value =
        AppState.schoolName === " " ? "" : AppState.schoolName;
      ...
      document.getElementById("input-grade").value =
        AppState.gradeInfo === " " ? "" : AppState.gradeInfo;
  ...
  document.addEventListener("paste", (e) => {
    ...
    const isTargetEditable =
      target.hasAttribute("contenteditable") || target.id === "source-text";
